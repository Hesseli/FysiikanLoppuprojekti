...
# Laske kiihtyvyyden suuruus (magnitude)
...
# Näytteenottotaajuus (oletuksena 50 Hz jos tietoja ei ole)
...
# Valitse z-komponentti pystysuuntaiselle kiihtyvyydelle
...
# Etsi dominantti taajuus askelille (tyypillisesti 1-3 Hz)
...
# Laske matka integroimalla nopeus
...
st.subheader("Tehospektritiheys (z-komponentti)")
...
ax2.set_title('Tehospektritiheys - Z-akseli')
ax2.set_xlim(0, 10)
ax2.legend()
